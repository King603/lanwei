...
class QRRSBlock {
	...
	static getRsBlockTable(typeNumber, errorCorrectLevel) {
		let num = (typeNumber - 1) * 4;
		switch (errorCorrectLevel) {
			case QRErrorCorrectLevel.L:
				return QRRSBlock.RS_BLOCK_TABLE[num + 0];
			case QRErrorCorrectLevel.M:
				return QRRSBlock.RS_BLOCK_TABLE[num + 1];
			case QRErrorCorrectLevel.Q:
				return QRRSBlock.RS_BLOCK_TABLE[num + 2];
			case QRErrorCorrectLevel.H:
				return QRRSBlock.RS_BLOCK_TABLE[num + 3];
			default:
				return undefined;
		}
	}
